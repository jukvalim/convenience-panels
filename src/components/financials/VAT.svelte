...
<div>
  ...
  <input id="price" type="number" min="0" step="0.01" on:input={updatePrice} bind:value={price} />
  </div>
  ...
  <input id="total" type="number" min="0" step="0.01" on:input={updateTotal} bind:value={total} />
  </div>
